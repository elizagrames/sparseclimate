# Code adapted from Roberts and Zhao (2022). A Bayesian mixture model for 
# changepoint estimation using ordinal predictors. The International Journal of 
# Biostatistics. doi: 10.1515/ijb-2020-0151/
